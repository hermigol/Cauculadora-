...
function calculateHourlyRate() {
    ...
    if (weeksWorkedPerYear <= 0 || hoursPerDay <= 0 || daysPerWeek <= 0) {
        alert("O número de semanas trabalhadas por ano deve ser maior que zero. Você só pode ter até 51 semanas de férias por ano.");
        return null;
    }
